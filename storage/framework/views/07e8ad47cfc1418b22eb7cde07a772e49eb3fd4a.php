<div class="admin-sidebar">
    ...
    <div class="side-body">
        <div class="user-status">
            <div class="user-img">
                <a href=#><img src="/images/<?php echo e(auth()->user()->avatar); ?>" id="avatar"></a>
            </div>
        ...
        <div class="side-menu">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('isAdmin')): ?>
                ...
                <div class="side-drop-show">
                    <ul>
                    <a href="<?php echo e(route('artadd')); ?>"><li>اضافه کردن مقاله جدید</li></a>
                    <a href="<?php echo e(route('articles-list')); ?>"><li>لیست مقالات</li></a>
                    <a href="<?php echo e(route('comments')); ?>"><li>کامنت ها</li></a>
                    </ul>
                </div>
                <div class="menu-items" >
                ...
                <div class="side-drop-show">
                    <ul>
                    <a href="<?php echo e(route('categories-add')); ?>"><li>اضافه کردن دسته بندی جدید</li></a>
                    <a href="<?php echo e(route('catList')); ?>"><li>لیست دسته بندی ها</li></a>
                    </ul>
                </div>               
                <div class="menu-items">
...
</div><?php /**PATH C:\Users\Hady\Desktop\Paragon\resources\views/layouts/admin-sidebar.blade.php ENDPATH**/ ?>